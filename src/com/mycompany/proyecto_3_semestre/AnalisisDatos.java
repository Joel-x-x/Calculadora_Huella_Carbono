        ...
        for (int i = 0; i < 770; i++) {
            ...
            switch (contadorPreguntas) {
                case 1:
                    ...
                    switch (pregunta_1) {
                        case "10 a 20":
                            suma_huella = suma_huella + 0.267;
                            break;
                        case "20 a 30":
                            suma_huella = suma_huella + 0.345;
                            break;
                        case "Más de 30":
                            suma_huella = suma_huella + 0.450;
                            break;
                    }
                    break;
                case 2:
                    ...
                    switch (pregunta_2) {
                        case "1":
                            suma_huella = suma_huella + 0.130;
                            break;
                        case "2":
                            suma_huella = suma_huella + (0.130 * 2);
                            break;
                        case "3":
                            suma_huella = suma_huella + (0.130 * 3);
                            break;
                        case "Más de 3":
                            suma_huella = suma_huella + (0.130 * 4);
                            break;
                        case "No uso gas":
                            break;
                    }
                ...
                case 3:
                    ...
                    switch (pregunta_3) {
                        ...
                        case "Ahorradores":
                            ...
                            break;
                        case "Incandescentes":
                            suma_huella = suma_huella + (0.6375);
                            break;
                    }
                    break;
                case 4:
                    ...
                    switch (pregunta_4) {
                        case "Menos de 1 hora":
                            suma_huella = suma_huella + (0.272);
                            break;
                        case "1 hora":
                            suma_huella = suma_huella + (0.672);
                            break;
                        case "2 horas":
                            suma_huella = suma_huella + (0.672 * 2);
                            break;
                        case "3 horas":
                            suma_huella = suma_huella + (0.672 * 3);
                            break;
                        case "Más de 3 horas":
                            suma_huella = suma_huella + (0.672 * 4);
                            break;
                ...
                case 9:
                    ...
                    switch (pregunta_9) {
                        case "Diario":
                            suma_huella = suma_huella + (0.645);
                            break;
                        case "4 - 6 días a la semana":
                            suma_huella = suma_huella + (0.496);
                            break;
                        case "1 - 3 días a la semana":
                            suma_huella = suma_huella + (0.365);
                            break;
                        case "No consumo":
                            break;
                    }
