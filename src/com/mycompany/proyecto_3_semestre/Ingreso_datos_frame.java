 ...
 * @author USER
 */
public class Ingreso_datos_frame extends javax.swing.JFrame {

    /**
     * Creates new form Ingreso_datos_frame
     */
    public Ingreso_datos_frame() {
        initComponents();
    }
int xMouse,yMouse;
    /**
    ...
    private void initComponents() {
        ...
        btt_analisis.setRolloverEnabled(true);
        ...
        btt_grafico1.setRolloverEnabled(true);
        ...
        jLabel1.setText("En la población de la Ambato");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ingreso_datos_frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ingreso_datos_frame().setVisible(true);
            }
        });
    }
